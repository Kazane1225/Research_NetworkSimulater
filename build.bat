...
rem -pthread / -s USE_PTHREADS=1 enable the real compute worker thread (src\compute_job.c);
rem this requires the page to be served cross-origin-isolated (COOP/COEP), which
rem scripts\serve.js already sets.
call emcc ^
