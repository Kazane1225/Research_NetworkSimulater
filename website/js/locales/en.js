...
const LOCALE_EN = {
    ...
    guidedStab: [
        ...
        { title: 'Provisional Guesses',                           body: 'L turns green (anonymity 1). Symmetric groups often start yellow \u2014 guesses, not proven facts. Red means an incorrect guess. Stabilizing is allowed to be wrong before it settles; that is the defining risk.',                                                                                                    action: null,                                                        highlight: null            },
    ...
    guidedTerm: [
        ...
        { title: 'Watch Uncommitted Colours',                     body: 'Press \u25b6 Step. Cyan marks an early, uncommitted guess; orange marks intermediate refinement. Nodes do not turn red: the algorithm refuses to lock in an incorrect answer.',                                                                                                                                      action: 'Press \u25b6 Step or Space',                                highlight: '#btn-step'     },
        { title: 'Certificates, Not Just Guesses',                body: 'Terminating builds evidence step by step: guessers seed anonymity estimates, heavy nodes check consistency, and verified isles or cuts act as a certificate. Only then may the root turn green and halt.',                                                                                                           action: null,                                                        highlight: null            },
